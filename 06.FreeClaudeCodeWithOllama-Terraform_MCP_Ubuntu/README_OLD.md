...
**⚠️ Important:** Log out and log back in (or restart) for this to take effect.
...
### 3.2 Add HashiCorp's APT repository
...
## ☁️ Step 4: Install AWS CLI v2

### 4.1 Download AWS CLI installer

```bash
curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip" -o "awscliv2.zip"
```

### 4.2 Unzip the installer
...
## 🏛️ Step 6: Create Terraform Cloud Token

This is **critical** for the MCP Server to work.

### 6.1 Log in to Terraform Cloud

Go to: https://app.terraform.io/

Create a free account if you don't have one.

### 6.2 Generate an API token
...
**⚠️ Warning:** This is sensitive. Treat it like a password.

---

## 📝 Step 7: Configure Terraform with Your Token

### 7.1 Create credentials file

```bash
mkdir -p ~/.terraform.d
```

### 7.2 Create credentials configuration
...
**Replace `YOUR_TOKEN_HERE`** with your actual token from Step 6.

### 7.3 Set secure permissions
...
## 💻 Step 8: Install VS Code (If Not Already Installed)

### 8.1 Add Microsoft's GPG key
...
## 🤖 Step 9: Install Claude Code Extension for VS Code
...
## 🌉 Step 10: Configure Terraform MCP Server

### 10.1 Create Docker network (optional but recommended)
...
### 10.2 Pull the Terraform MCP Server image
...
## 🔗 Step 11: Configure MCP in Claude Code

### 11.1 Open VS Code settings

Press `Ctrl+,` (or go to **File → Preferences → Settings**)

### 11.2 Open settings.json

Click the icon in the top-right (looks like `{}`) to open JSON settings.

### 11.3 Add MCP configuration
...
### 12.2 Test Docker with Terraform image
...
### 12.5 Verify Claude Code in VS Code
...
## 🧪 Step 13: Test the Full Setup

### 13.1 Create a test Terraform project
...
### 13.4 Validate the generated code
...
**OS:** Ubuntu 22.04 LTS  
**Stack:** Docker + Terraform + AWS CLI + Claude Code for VS Code  

---

**You're all set! 🚀 Happy infrastructure coding!**